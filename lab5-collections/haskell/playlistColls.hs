...
adsFromPlaylists = [ item | adsplaylist <- playlists, item <- adsplaylist, (isAdvert item) ] -- TASK 5.4(b)

shortItemLenghts1 = [item_length_secs item | item <- playlist1, item_length_secs item < 20.0 ] -- TASK 5.4(a)
